              ...
              <div class="card card-primary">
                <form @submit.prevent="checkMode">
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      <label for="description" class="h4">Permissions Description</label>
                      <input
                        type="text"
                        class="form-control"
                        id="description"
                    ...
                    <div
                      class="invalid-feedback mb-3"
                      :class="{
                        'd-block': form.errors.description,
                      }"
                    >
                  ...
                  <div class="modal-footer justify-content-between">
                    ...
                    <button
                      ...
                      class="btn btn-info text-uppercase"
                      style="letter-spacing: 0.1em"
                       :disabled="!form.name || form.processong"
                    >
                      {{ btnSubmit }}
                    </button>
                  </div>
       ...
       Swal.fire({
         ...
         if (result.isConfirmed) {
           this.form.delete(this.route("admin.permissions.destroy", permission), {
             preserveScroll: true,
             onSuccess: () => {
               Swal.fire("Deleted!", "Permissions has been deleted.", "success");
             },
           });
         }
       });
